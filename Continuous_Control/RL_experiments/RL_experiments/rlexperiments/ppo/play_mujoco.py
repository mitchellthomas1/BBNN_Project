...
def main():
    ...
    parser.add_argument('--env', help='Gym environment ID', default='RoboschoolHopper-v1')
    parser.add_argument('--model-path', help='TensorFlow model path', default = '/images/model')
