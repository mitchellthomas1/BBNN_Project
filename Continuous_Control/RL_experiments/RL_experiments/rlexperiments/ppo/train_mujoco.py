...
def train(env_id , num_timesteps, seed, cuda_visible_devices, gpu_memory_fraction, output_dir, record_video, record_video_freq = 100):
    ...
    ppo.learn(policy=policy, env=env, sess=sess, nsteps= 992, nminibatches=32,
...
def main():
    ...
    parser.add_argument('--num-timesteps', help='number of timesteps', type=int, default= 1372160)
    ...
    parser.add_argument('--output-dir', help='base directory to store models and summaries', default='/Users/Mitchell/Documents/IRES/RL_experiments/trainingfiles')
